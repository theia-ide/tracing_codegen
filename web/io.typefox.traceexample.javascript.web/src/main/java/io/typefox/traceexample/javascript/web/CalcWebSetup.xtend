...
import io.typefox.traceexample.javascript.ide.CalcIdeModule
import org.eclipse.xtext.util.Modules2

/**
 * Initialization support for running Xtext languages in web applications.
 */
class CalcWebSetup extends CalcStandaloneSetup {
	
	override Injector createInjector() {
		return Guice.createInjector(Modules2.mixin(new CalcRuntimeModule, new CalcIdeModule, new CalcWebModule))
	}
